...
| 2 | pgAdmin | `http://dbs.home.arpa:5050` | `admin@local.dev` | `change_me_pgadmin_2026` |
| 3 | Redis | `dbs.home.arpa:6379` | `default` | `change_me_redis_2026` |
| 4 | RedisInsight | `http://dbs.home.arpa:5540` | No app login | No app password |
| 5 | Neo4j Browser | `http://dbs.home.arpa:7474` | `neo4j` | `change_me_neo4j_2026` |
